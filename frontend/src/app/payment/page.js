    ...
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <div className="flex justify-center mb-8">
        <div className="flex items-center text-sm font-medium">
          ...
          <span className="text-indigo-600 font-bold border-b-2 border-indigo-600 pb-1">Payment</span>
          <span className="mx-2 text-gray-400">&gt;</span>
          <span className="text-gray-400">Place Order</span>
        </div>
      </div>

      <h1 className="text-2xl font-bold mb-6 text-gray-800 uppercase tracking-wide">Payment Method</h1>
      
      <form onSubmit={submitHandler}>
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3">Select Method</h2>
