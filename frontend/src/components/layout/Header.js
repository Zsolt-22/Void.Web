        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="hidden md:flex space-x-8 items-center">
            {userInfo && userInfo.isAdmin && (
              <Link href="/admin" className="flex items-center hover:text-purple-300 transition text-yellow-400 font-bold">
        ...
        <div className="md:hidden bg-purple-950">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {userInfo ? (
              <>
                {userInfo.isAdmin && (
                  <Link href="/admin" className="block px-3 py-2 rounded-md bg-yellow-600/20 text-yellow-400 font-bold border border-yellow-600/30 mb-2">
                    Yönetici Paneli
                  </Link>
                )}
                ...
                {userInfo.isAdmin && (
                  <>
                    <Link href="/admin/userlist" className="block px-3 py-2 rounded-md hover:bg-purple-800 text-purple-300 ml-2">Admin: Kullanıcılar</Link>
                    <Link href="/admin/productlist" className="block px-3 py-2 rounded-md hover:bg-purple-800 text-purple-300 ml-2">Admin: Ürünler</Link>
                    <Link href="/admin/orderlist" className="block px-3 py-2 rounded-md hover:bg-purple-800 text-purple-300 ml-2">Admin: Siparişler</Link>
                  </>
                )}
